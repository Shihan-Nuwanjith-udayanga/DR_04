    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View style={styles.container}>
          <Image
            source={require('../assets/images/standalone.png')}
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.categoryView}>
            <TouchableOpacity
              ...
              <Image
                source={require('../assets/images/mysql.png')}
                style={styles.categoryImage}
              />
          ...
          <View style={styles.categoryView}>
            <TouchableOpacity
              ...
              <Image
                source={require('../assets/images/cPlus.png')}
                style={styles.categoryImage}
              />
          ...
          <View style={styles.categoryView}>
            <TouchableOpacity
              ...
              <Image
                source={require('../assets/images/cSharp.png')}
                style={styles.categoryImage}
              />
              <Text style={styles.txtCategory}>C#</Text>
            </TouchableOpacity>
          ...
          <View style={styles.categoryView}>
            <TouchableOpacity
              style={styles.categoryTouchable}
              onPress={() =>
                Linking.openURL('https://spring.io/projects/spring-boot/')
              }>
              <Image
